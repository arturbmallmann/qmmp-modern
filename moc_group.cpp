...
QT_MOC_LITERAL(1, 6, 6), // "object"
QT_MOC_LITERAL(2, 13, 10), // "GuiObject*"
QT_MOC_LITERAL(3, 24, 0), // ""
QT_MOC_LITERAL(4, 25, 2), // "id"
QT_MOC_LITERAL(5, 28, 11) // "instance_id"

    },
    "Group\0object\0GuiObject*\0\0id\0instance_id"
};
...
void Group::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { GuiObject* _r = _t->object((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< GuiObject**>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->m_instanceId; break;
        default: break;
        }
        ...
        switch (_id) {
        case 0:
            if (_t->m_instanceId != *reinterpret_cast< QString*>(_v)) {
                _t->m_instanceId = *reinterpret_cast< QString*>(_v);
            }
            break;
        default: break;
        }
...
const QMetaObject Group::staticMetaObject = {
    { &GuiObject::staticMetaObject, qt_meta_stringdata_Group.data,
