...
QT_MOC_LITERAL(3, 22, 11) // "activeimage"

    },
    "ToggleButton\0toggled\0\0activeimage"
};
...
void ToggleButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ToggleButton::toggled)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->activeImage(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setActiveImage(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
const QMetaObject ToggleButton::staticMetaObject = {
    { &Button::staticMetaObject, qt_meta_stringdata_ToggleButton.data,
